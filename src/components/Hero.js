...
function Hero() {
  ...
  <div className="container home-container  flex   md:flex-row flex-col items-center">
    <div className="lg:flex-grow md:w-1/2 lg:pr-24 px-3 md:pr-16 flex flex-col md:items-start md:text-left mb-16 md:mb-0 items-center ">
      <h1 className=" sm:text-4xl text-3xl mb-4 font-bold text-gray-900 ">Portrait <span className= " text-yellow-500 ">Painting</span> to Tell Your<span className = "text-red-500"> Stories...</span> </h1>
      <h3 className=" sm:text-1.5xl text-xl mb-3 font-bold text-yellow-500 ">Upload a photo to transform into <span className = "text-red-500">masterpieces</span></h3>
      <h3 className=" sm:text-2.5xl text-2xl mb-3 font-bold text-black-400 ">JUST IN <span className = "text-red-500"> 15 </span> DAYS !</h3>
